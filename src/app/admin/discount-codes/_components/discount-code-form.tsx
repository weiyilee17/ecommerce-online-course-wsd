...
function DiscountCodeForm({ products }: { products: Pick<Product, 'id' | 'name'>[] }) {
  const [error, dispatch] = useFormState(addDiscountCode, {});
    ...
    >
      ...
      <div className='space-y-2'>
        ...
        <Input
          ...
          id='expiresAt'
          name='expiresAt'
          // remove the seconds part from the string, but also removes timezone
          className='w-max'
